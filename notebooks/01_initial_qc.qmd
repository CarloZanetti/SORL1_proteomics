...
The Spectronaut search used a concatenated human + mouse FASTA. Retain only rows
whose primary protein group accession maps to `org.Hs.eg.db` so that mouse
host-derived proteins are excluded before QC metrics are computed.
